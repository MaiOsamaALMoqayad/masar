...
import { ArrowLeft, Clock, Filter, MapPin, Star, Wrench } from "lucide-react"
...
export const metadata = {
  title: "Auto Services | Masar",
  description: "Find auto repair shops, mechanics, and car services near you",
}
...
export default function AutoServicesPage() {
  ...
  const autoServices = allServices.filter(
    (service) =>
      service.category === "Auto Services" || service.tags?.includes("auto") || service.tags?.includes("car"),
  )
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-8">
        <div className="md:w-2/3">
          <h1 className="text-3xl font-bold mb-2">Auto Services</h1>
          <p className="text-muted-foreground mb-4">
            Find mechanics, repair shops, car washes, and other automotive services
          </p>
        </div>
        <div className="md:w-1/3 flex flex-col gap-4">
          <div className="relative">
            <Input placeholder="Search auto services..." className="pl-10" />
            <svg
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center">
                    <input type="checkbox" id="certified" className="mr-2" />
                  ...
                  <div className="flex items-center">
                    <input type="checkbox" id="loaner" className="mr-2" />
                    <label htmlFor="loaner" className="text-sm">
                      Loaner Cars
                    </label>
                  </div>
                  <div className="flex items-center">
        ...
        <div className="md:w-3/4">
          <div className="flex justify-between items-center mb-4">
            <div className="text-sm text-muted-foreground">
              Showing <span className="font-medium">{autoServices.length}</span> auto services
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {autoServices.length > 0 ? (
                ...
                <Card key={service.id} className="overflow-hidden">
                  <CardHeader className="p-0">
                    <div className="relative h-48 w-full">
                      <img
                        src={service.image || `/placeholder.svg?height=200&width=400&query=auto+repair+shop`}
                        alt={service.name}
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="text-sm text-muted-foreground mb-2">
                      {service.serviceType || "Auto Repair Shop"}
                    </div>
                    ...
                    <div className="flex items-center mb-2">
                      ...
                      <span className="text-sm text-muted-foreground ml-1">
                        ({service.reviewCount || "52"} reviews)
                      </span>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-1 mb-2">
                      {(service.specialties || ["Oil Change", "Brake Service", "Engine Repair"]).map(
                        (specialty, index) => (
                          <span
                            key={index}
              ...
              <div className="col-span-2 text-center py-12">
                <h3 className="text-xl font-medium mb-2">No auto services found</h3>
